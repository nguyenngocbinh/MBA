---
title: "Market basket analysis - already had products"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{mba_past2}
...
Dữ liệu đầu vào là product holding của các khách hàng (chỉ xét khách hàng có contact_date từ sau 1/1/2017, và những sản phẩm khách hàng đã từng có)


```{r import data}
load("product_past.RData")
```
...
- Có 6291 (count = 6291) trường hợp khách hàng đã sử dụng **sản phẩm bảo hiểm AIA** sẽ sử dụng thêm **sản phẩm card_credit**, chiếm 2.1% (support = 0.0208), với độ tin cậy 67.6% (confidence = 0.676). Nghĩa là 100 khách hàng mua sản phẩm AIA thì sẽ có 67 khách hàng sử dụng thêm sản phẩm credit card. 

- Hiện tại, tỷ lệ khách hàng đã sử dụng sản phẩm AIA và sản phẩm card_credit là 2.1% (support = 0.021) như vậy vẫn còn tiềm năng lớn để khai thác rule như thế này

- Mặt khác, khả năng khách hàng đã sử dụng sản phẩm bảo hiểm AIA sẽ sử dụng thêm sản phẩm card_credit cao hơn (3.8 - 1) lần so với bình thường. Tức là khả năng bán thành công sản phẩm card credit cho khách hàng đã sử dụng sản phẩm bảo hiểm AIA cao hơn 2.8 lần so với khi khách hàng chưa sử dụng sản phẩm nào
